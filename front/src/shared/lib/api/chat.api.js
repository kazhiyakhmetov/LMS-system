...
export const chatApi = {
  ...
  send: ({ receiverId, content, replyToId, attachmentUrl, attachmentName, attachmentSize }) =>
    http.post("/chat/send", { receiverId, content, replyToId, attachmentUrl, attachmentName, attachmentSize }),
