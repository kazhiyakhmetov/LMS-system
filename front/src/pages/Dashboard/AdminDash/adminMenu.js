export const adminMenu = [
  { href: "/admin", labelKey: "nav.admin.stats", icon: "chart", end: true },
  { href: "/admin/users", labelKey: "nav.admin.users", icon: "users" },
  { href: "/admin/registration", labelKey: "nav.admin.registration", icon: "user-plus" },
  { href: "/admin/classes", labelKey: "nav.admin.classes", icon: "academic" },
